...
class Approvals
{
	...
	public function render_page()
	{
		...
		<div class="wrap">
			...
			<p><?php esc_html_e('Approvals are reserved for the client-approval-workflow Pro add-on. The free plugin keeps the menu location, schema, and hooks ready so a Pro module can attach cleanly.', 'client-approval-workflow'); ?></p>
