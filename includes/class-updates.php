...
class Updates
{
	...
	public function register_post_type()
	{
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'          => __('Updates', 'signoffflow-client-approval-workflow'),
					'singular_name' => __('Update', 'signoffflow-client-approval-workflow'),
					'menu_name'     => __('Updates', 'signoffflow-client-approval-workflow'),
					'add_new_item'  => __('Add Update', 'signoffflow-client-approval-workflow'),
					'edit_item'     => __('Edit Update', 'signoffflow-client-approval-workflow'),
					'new_item'      => __('New Update', 'signoffflow-client-approval-workflow'),
					'view_item'     => __('View Update', 'signoffflow-client-approval-workflow'),
					'search_items'  => __('Search Updates', 'signoffflow-client-approval-workflow'),
					'not_found'     => __('No updates found.', 'signoffflow-client-approval-workflow'),
				),
				'public'              => false,
				'show_ui'             => true,
	...
	public function register_meta_boxes()
	{
		add_meta_box(
			...
			__('Update Details', 'signoffflow-client-approval-workflow'),
	...
	public function render_update_details_meta_box($post)
	{
		...
		?>
		<p>
			<label for="cliapwo_update_client_id"><strong><?php esc_html_e('Client', 'signoffflow-client-approval-workflow'); ?></strong></label>
		</p>
		<select
			class="widefat"
		...
		<p class="description"><?php esc_html_e('Updates are shown only in the assigned client account portal.', 'signoffflow-client-approval-workflow'); ?></p>
		<?php
	}
	...
	{
		$columns['cliapwo_update_client'] = __('Client', 'signoffflow-client-approval-workflow');
	...
	public function render_update_column($column, $post_id)
	{
		...
		if (! $client instanceof \WP_Post) {
			echo esc_html__('Unassigned', 'signoffflow-client-approval-workflow');
			return;
		}
